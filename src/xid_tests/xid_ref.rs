//! I've copied in a slightly update version of https://github.com/jeromer/libxid for sanity impl tests
...
fn platform_machine_id() -> Result<String, io::Error> {
    ...
    let result = fs::File::open("/etc/machine-id");
    ...
    match result {
        ...
        _ => {
            ...
            let mut file = fs::File::open("/sys/class/dmi/id/product_uuid")?;
